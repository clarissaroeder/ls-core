...
def tfidf(term, document, documents)
  tf(term, document) * idf(term, documents) # -> anything multiplied by 0 is 0
end
...
def idf(term, documents)
  ...
  Math.log(number_of_documents.fdiv(number_of_documents_with_term)) # if there is two documents with the term, this value returns 0.0
